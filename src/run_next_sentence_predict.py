...
VAL_FILE = f'{config.DATA_DIR}\\triple_classification_val.jsonl'
TRAIN_FILE = f'{config.DATA_DIR}\\triple_classification_train.jsonl'
DEV_FILE = f'{config.DATA_DIR}\\triple_classification_dev.jsonl'
