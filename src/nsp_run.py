...
def run():
   ...
   python src/nsp_model.py  --test_fn {dev_fn} --template_fn res/prompts0.csv  --output {OUTPUT_FILE} --train_fn {train_fn}  --train_batch_size 16 --gpu 0 --top_k 15 --threshold 0.1  --dev_fn   {dev_fn} --mode "tra in  test" --train_epoch 20 --learning_rate 5e-5 --model_load_dir {model_load_dir} --model_save_dir {model_save_dir} --model_best_dir  {model_best_dir}
